...
COCO(Common Object in Context) dataset is used for training.
...
YOLO is a deep learning algorithm which came out on may 2016 and it became quickly so popular because it’s so fast compared with the previous deep learning algorythm.
